...
export class DriversComponent implements OnInit {
    dataOriginal: any[] = [
        ...
        { id: 8, nombre: 'Carlos Puma Chavez', fecha: new Date() },
        { id: 9, nombre: 'Luis Puma Chavez', fecha: new Date() },
        ...
        { id: 13, nombre: 'Luis Puma Chavez', fecha: new Date() },
        { id: 14, nombre: 'Jose Puma Chavez', fecha: new Date() },
        { id: 15, nombre: 'Carlos Puma Chavez', fecha: new Date() },
        { id: 16, nombre: 'Jose Puma Chavez', fecha: new Date() }
    ];
    ...
    metaDataColumns: MetaDataColumn[] = [
        { field: 'id', title: 'ID' },
        { field: 'nombre', title: 'Nombre completo del conductor' },
